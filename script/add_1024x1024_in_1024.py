...
def calculate_addition_in_1024(args):
    a0 = int(args.a0)
    a1 = int(args.a1)
    a2 = int(args.a2)
    a3 = int(args.a2)
    ...
    addend1 = (a3 * int(word)**3) + (a2 * int(word)**2) + (a1 * int(word)) + a0
    addend2 = (b3 * int(word)**3) + (b2 * int(word)**2) + (b1 * int(word)) + b0
    result = int(addend1) + int(addend2)
...
def main():
    args = parse_args()
    calculate_addition_in_1024(args)
